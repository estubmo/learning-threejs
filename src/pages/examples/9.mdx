import Example9 from "../../components/Example9.astro";
import Layout from "../../layouts/Layout.astro";

<Layout title="Viewport - Learning Three.js">
  <div class="h-screen py-10 md:py-20">
    <Example9 title="Viewport" description="Full-Screen and Resizing" />
  </div>
  <button id="full-screen-button" class="border-black px-4 py-2 w-24 place-self-center border tracking-wider hover:bg-zinc-900/5">Full-Screen</button>
