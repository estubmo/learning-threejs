import Example6 from "../../components/Example6.astro";
import Layout from "../../layouts/Layout.astro";

<Layout title="Cameras - Learning Three.js">
  <div class="h-screen py-10 md:py-20">
    <Example6 title="Cameras" description="Ortographic Camera and Basic Cursor Movement" />
  </div>
...
function animate() {
  ...
  camera.position.x = Math.cos(cursor.y * 10)
